...
register({ id: 'web-agent', name: 'Web Agent', description: 'Signs up for websites, fills forms, scrapes data, web UI interaction via visual browser. Facebook account management and autonomous agents. Sessions appear in Browser View — users can watch the agent work in real time via VNC.', systemPrompt: webAgentPrompt, model: 'dynamic', preferredOllamaModel: 'kimi-k2.5', tools: ['browser', 'facebook', 'bash', 'search', 'file', 'memory'], maxTokens: 4096, temperature: 0.3, maxToolIterations: 15 });
