...
register({ id: 'researcher', name: 'Researcher', description: 'Searches the web, answers questions, summarizes information. Can scrape any site, find APIs, and run scrapers.', systemPrompt: researcherPrompt, model: 'dynamic', tools: ['search', 'scrape', 'browser', 'memory', 'firecrawl', 'rapidapi', 'apify'], maxTokens: 4096, temperature: 0.7, maxToolIterations: 15 });
...
register({ id: 'general', name: 'General Assistant', description: 'Casual conversation, help, and general knowledge.', systemPrompt: generalPrompt, model: 'dynamic', tools: ['bash', 'search', 'file', 'cron', 'memory', 'email', 'analytics', 'claude-code', 'social', 'kie', 'workflow'], maxTokens: 4096, temperature: 0.5, maxToolIterations: 12 });
